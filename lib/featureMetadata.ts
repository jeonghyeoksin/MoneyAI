...
export const FEATURE_METADATA: Record<string, FeatureMetadata> = {
  ...
  [AppView.YOUTUBE_VIDEO]: {
    manual: "1. 제작하고 싶은 영상의 내용을 상세한 문장으로 입력하세요.\n2. 화면 비율(16:9, 9:16)과 자막 포함 여부를 선택하세요.\n3. 생성 버튼을 누르면 고퀄리티 시네마틱 영상이 제작됩니다 (약 1분 소요).",
    minCost: 2000,
    maxCost: 8000
  }
};
...
export const PATCH_NOTES = [
  {
    date: "2026.04.20",
    content: [
      "유튜브 영상 제작(Veo) 기능 업그레이드 - 화면 비율(16:9, 9:16) 및 한국어 자막 옵션 추가",
